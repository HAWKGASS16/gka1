...
public class DijkstraFloydTest {
	...
	public void testDijkstra() {
		...
		assertEquals(vg01, dijkstra01.getKosten("1", "4"),0.001);
		...
		assertEquals(vg02, dijkstra03.getKosten("Hamburg", "Husum"),0.001);
	...
	public void testFloydWarshall() {
		...
		assertEquals(vg, fw01.getKosten("1", "4"),0.001);
		...
		assertEquals(vg02, fw03.getKosten("Hamburg", "Husum"),0.001);
		...
		dijkstra03.suche();
		assertEquals(dijkstra03.getKosten("Hamburg", "Husum"), fw03.getKosten("Hamburg", "Husum"),0.001);
		dijkstra04.suche();
	...
	public void testBIG() {
		...
		assertEquals(vg03, dijkstra05.getKosten("Node1", "v1"),0.001);
		...
		assertEquals(vg03, fw05.getKosten("Node1", "v1"),0.001);
